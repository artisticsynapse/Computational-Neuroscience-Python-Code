...
* **Information theory, and Neural Coding**: Plotting the tuning curves of neurons in the cercal organs of a cricket insect (click the Binder logo below to interact with the [Jupyter Notebook](https://mybinder.org/v2/gh/artisticsynapse/Computational-Neuroscience-Python-Code/master?filepath=Information%20theory%2C%20and%20Neural%20Coding.ipynb)): <br>
